...
;; computes f and returns a procedure that computes the smoothed f. It is sometimes 
;; valuable to repeatedly smooth a function (that is, smooth the smoothed function, 
;; and so on) to obtained the n-fold smoothed function. 
...
((n-fold-smooth square 10) 2)       ; 4.000000000666667