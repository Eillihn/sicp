...
;; two positive integers in terms of the procedures inc, 
...
;;         b
;;         (+ (dec a) (inc b))))
;; 1) Using the substitution model, illustrate the process generated by each procedure 
;; in evaluating (+ 4 5).
;; 2) Are these processes iterative or recursive?
