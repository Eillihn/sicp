...
; that was used above to estimate pi. Use your estimate-integral to produce an estimate of by
...
; S = S[rect] * (K/N), S[rect] - 36, as r = 3 => d = 6, N = 10000
(define kn (estimate-integral P 2.0 8.0 4.0 10.0 10000))
(define s (* 36.0 kn))
; S = pi * r ^ 2 = pi * 9, pi:
(/ s 9.0)     ; 3.144
