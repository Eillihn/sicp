...
; l S begins with 1.
; l The elements of (scale-stream S 2) are also elements of S.
; l The same is true for (scale-stream S 3) and (scale-stream 5 S).
; l These are all the elements of S.
