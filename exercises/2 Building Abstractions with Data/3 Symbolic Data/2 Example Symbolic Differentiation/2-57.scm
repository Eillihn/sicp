...
;; Extend the differentiation program to handle sums and products of arbitrary numbers 
...
;; changing the deriv procedure at all. 
;; For example, the addend of a sum would be the first term, and the augend would be 
...
;; Test code:
(display (deriv '(* x y (+ x 3)) 'x))           ;;(+ (* x y) (* y (+ x 3)))
