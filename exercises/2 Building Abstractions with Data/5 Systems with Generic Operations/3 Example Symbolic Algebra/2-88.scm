...
(define (install-scheme-number-package)
    ...
    (put 'negative '(scheme-number)
        (lambda (x) (make-scheme-number (- 0 x))))
    'done)
...
(define (install-rational-package)
    ...
    (put 'negative '(rational)
        (lambda (x) (make-complex-from-real-imag (- 0 (numer x)) (- 0 (denom x)))))
    'done)
...
(define (install-complex-package)
    ...
    (put 'negative '(complex)
        (lambda (z) (make-complex-from-real-imag (- 0 (real-part z)) (- 0 (imag-part z)))))
    'done)
...
(define (install-polynomial-package)
    ...
    (define (negative-terms t) (map (lambda (x) (make-term (order x) (negative (coeff x)))) t))
    ...
    (put 'negative '(polynomial)
        (lambda (p) (make-polynomial (variable p) (negative-terms (term-list p)))))
...
(sub b a)           ; '(polynomial x (2 (scheme-number . 2)) (1 (scheme-number . -2)))
(sub b c)           ; '(polynomial x (2 (polynomial x (2 (scheme-number . -1)) (1 (scheme-number . -2)) (0 3))) (1 (scheme-number . -4)))
(sub d a)           ; '(polynomial x (2 (scheme-number . 4)) (1 (scheme-number . -2)))
