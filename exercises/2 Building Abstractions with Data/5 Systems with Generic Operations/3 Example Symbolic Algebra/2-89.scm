...
(define (install-polynomial-package)
    ...
    (define (adjoin-term index term term-list)
        (if (= (- index 1) (length term-list))
            (cons term term-list)
            (cons term (adjoin-term (- index 1) (make-scheme-number 0) term-list))))
    (define (the-empty-termlist) '())
    (define (first-term term-list) (car term-list))
    (define (rest-terms term-list) (cdr term-list))
    (define (empty-termlist? term-list) (null? term-list))
    (define (order term term-list) (- (length term-list) (index-of term-list term)))
                ...
                (else
                    (let    ((t1 (first-term L1)) (t2 (first-term L2)))
                        (cond   ((> (order t1 L1) (order t2 L2))
                                    (adjoin-term (order t1 L1) t1 (add-terms (rest-terms L1) L2)))
                                ((< (order t1 L1) (order t2 L2))
                                    (adjoin-term  (order t2 L2) t2 (add-terms L1 (rest-terms L2))))
                                (else
                                    (adjoin-term (order t1 L1) (add t1 t2)
                                                    (add-terms (rest-terms L1)
                                                    (rest-terms L2)))))))))
    (define (mul-term-by-all-terms order1 t1 L)
        (if (empty-termlist? L)
            (the-empty-termlist)
            (let    ((t2 (first-term L)))
                (adjoin-term (+ order1 (order t2 L))
                    (mul t1 t2)
                    (mul-term-by-all-terms order1 t1 (rest-terms L))))))
    (define (mul-terms L1 L2)
        (if (empty-termlist? L1)
            (the-empty-termlist)
            (add-terms (mul-term-by-all-terms (- (length L1) 1) (first-term L1) L2)
...
;; Test code:
(define a (make-polynomial 'x (list (make-scheme-number 1) (make-scheme-number 0) (make-scheme-number 0) (make-scheme-number 3) (make-scheme-number -2) (make-scheme-number 2))))
(define b (make-polynomial 'x (list (make-scheme-number 3) (make-scheme-number 11))))

(add a b) ;         '(polynomial x (scheme-number . 1) (scheme-number . 0) (scheme-number . 0) (scheme-number . 3) (scheme-number . 1) (scheme-number . 13))
(mul a b) ;         '(polynomial x (scheme-number . 3) (scheme-number . 11) (scheme-number . 0) (scheme-number . 9) (scheme-number . 27) (scheme-number . -16) (scheme-number . 22))
