...
;; shown in figure 2.24. To his surprise, instead of the answer 5 he gets an error 
;; message from applygeneric, saying there is no method for the operation magnitude on 
;; the types (complex). He shows this interaction to Alyssa P. Hacker, who says ``The 
...
; (apply-generic 'magnitude (complex rectangular z))
; ...
; (type-tags (map type-tag (complex rectangular z))) => type-tags = (complex)
; (proc (get magnitude (complex))) => magnitude
; (apply magnitude (map contents (complex rectangular z)))
; (apply magnitude (rectangular z))
; ...
; (apply-generic magnitude (rectangular z))
; ...
; (type-tags (map type-tag (rectangular z))) => type-tags = (rectangular)
; (proc (get magnitude (rectangular))) => magnitude
; (apply magnitude (map contents (rectangular z)))
; (apply magnitude z)
; ...
