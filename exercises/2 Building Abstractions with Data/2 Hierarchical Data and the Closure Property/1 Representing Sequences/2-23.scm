...
;; applies the procedure to each of the elements in turn, from left to right. 
;; The values returned by applying the procedure to the elements are not used at all 
;; -- for-each is used with procedures that perform an action, such as printing.
;; For example,
